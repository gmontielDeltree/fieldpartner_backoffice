...
import { LicenciaDto, TipoLicencia, TipoSistema } from "../types";
...
export const ListaLicenciasPage: React.FC = () => {
  ...
  const filtrarLicencias = (licencias: LicenciaDto[], filtro: string): LicenciaDto[] => {
